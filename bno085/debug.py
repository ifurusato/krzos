...
# Gravity (m/s2)
# _BNO_REPORT_GRAVITY = 0x06 10 bytes

# Raw uncalibrated accelerometer data (ADC units). Used for testing
# _BNO_REPORT_RAW_ACCELEROMETER = 0x14 16

# Uncalibrated gyroscope (rad/s).
# _BNO_REPORT_UNCALIBRATED_GYROSCOPE = 0x07 16

# Raw uncalibrated gyroscope (ADC units).
# _BNO_REPORT_RAW_GYROSCOPE = 0x15 16

# Magnetic field uncalibrated (in µTesla). The magnetic field measurement without
# hard-iron offset applied, the hard-iron estimate is provided as a separate parameter.
# _BNO_REPORT_UNCALIBRATED_MAGNETIC_FIELD = 0x0F

# Raw magnetic field measurement (in ADC units). Direct data from the magnetometer.
# Used for testing.
# _BNO_REPORT_RAW_MAGNETOMETER = 0x16 16

# Geomagnetic Rotation Vector
# _BNO_REPORT_GEOMAGNETIC_ROTATION_VECTOR = 0x09

# Game Rotation Vector
# _BNO_REPORT_GAME_ROTATION_VECTOR = 0x08

# AR/VR Stabilized Game Rotation vector
# _BNO_REPORT_ARVR_STABILIZED_GAME_ROTATION_VECTOR = 0x29

# AR/VR Stabilized Rotation Vector
# _BNO_REPORT_ARVR_STABILIZED_ROTATION_VECTOR = 0x28

# Gyro rotation Vector
# Gyro rotation Vector Prediction

# _BNO_REPORT_TAP_DETECTOR       = 0x10
# _BNO_REPORT_STEP_COUNTER       = 0x11
# _BNO_REPORT_SIGNIFICANT_MOTION = 0x12

# _BNO_REPORT_SAR                = 0x17
# _BNO_REPORT_STEP_DETECTOR      = 0x18
# _BNO_REPORT_SHAKE_DETECTOR     = 0x19
# _BNO_REPORT_FLIP_DETECTOR      = 0x1A
# _BNO_REPORT_PICKUP_DETECTOR    = 0x1B
# _BNO_REPORT_STABILITY_DETECTOR = 0x1C
# _BNO_REPORT_SLEEP_DETECTOR     = 0x1F
# _BNO_REPORT_TILT_DETECTOR      = 0x20
# _BNO_REPORT_POCKET_DETECTOR    = 0x21
# _BNO_REPORT_CIRCLE_DETECTOR    = 0x22
