...
#           self._log.warning('compass not calibrated yet, call calibrate() first.')
    ...
    def _read_hardware(self):
        '''
        Reads hardware and updates accelerometer and gyroscope values.
        Magnetometer is handled within _read_yaw when called.
        '''
        self._accel[0], self._accel[1], self._accel[2], \
        self._gyro[0], self._gyro[1], self._gyro[2] = self.__icm20948.read_accelerometer_gyro_data()
