...
RESPONSE_PIR_ACTIVE         = Response(0x20, "PIRA", "pir active")
RESPONSE_PIR_IDLE           = Response(0x21, "PIRI", "pir idle")
RESPONSE_PIR_ON             = Response(0x22, "PIRO", "pir on")
RESPONSE_PIR_OFF            = Response(0x23, "PIRF", "pir off")
