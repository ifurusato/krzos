...
class Gamepad(Component):
    ...
    def _handleEvent(self, event):
        ...
        if event.type == ecodes.EV_KEY:
            ...
            self._log.info("event type: EV_KEY; event code: {}; value: {}; _control: {}".format(event.code, event.value, _control))
            if event.code == GamepadMapping.L3_VERTICAL.code:
                ...
                self._log.info(Fore.MAGENTA + "R3 Vertical {}".format(event.value))
                _control = GamepadMapping.R3_VERTICAL
                ...
                self._log.info(Fore.YELLOW + "R3 Horizontal {}".format(event.value))
                if self._suppress_horiz_events:
                    _control = None
                return None
            elif event.value == 1:
            ...
            if _control == GamepadMapping.DPAD_HORIZONTAL:
                ...
                self._log.info(Fore.RED + "L3 Vertical {}".format(event.value))
                _control = GamepadMapping.R3_VERTICAL
            elif event.code == GamepadMapping.R3_VERTICAL.code:
                self._log.debug(Fore.RED + "R3 Vertical {}".format(event.value))
                _control = GamepadMapping.R3_VERTICAL
            elif event.code == GamepadMapping.L3_HORIZONTAL.code:
                self._log.info(Fore.RED + "L3 Horizontal {}".format(event.value))
                if self._suppress_horiz_events:
                    _control = None
            elif event.code == GamepadMapping.R3_HORIZONTAL.code:
