...
class GamepadMapping(Enum):
    ...
    def get_by_code(self, event):
        ...
        '''
        _code = event.code
        if _code == GamepadMapping.L3_VERTICAL.code:
            return GamepadMapping.L3_VERTICAL
        elif _code == GamepadMapping.R3_VERTICAL.code:
            return GamepadMapping.R3_VERTICAL
        elif _code == GamepadMapping.DPAD_HORIZONTAL.code:
            if event.value == 1:
