...
class Geofence(AsyncBehaviour):
    ...
    The boundary and initial robot pose are configured in config.yaml under
    kros.behaviour.geofence:
    
        geofence:
            enable: True
            release: True
            verbose: False
            min_x: 0.0                      # west boundary (cm)
            max_x: 300.0                    # east boundary (cm)
            min_y: 0.0                      # south boundary (cm)
            max_y: 400.0                    # north boundary (cm)
            initial_x: 0.0                  # starting x position (cm)
            initial_y: 0.0                  # starting y position (cm)
            initial_theta: 0.0              # starting heading (degrees: 0=east, 90=north)
            margin: 50.0                    # reaction distance from boundary (cm)
            max_lateral_force: 0.8          # maximum vx magnitude
            max_rotation_force: 0.5         # maximum omega magnitude
            easing: 'SQUARE_ROOT'           # force scaling with distance
            min_priority: 0.3               # priority when far from boundaries
            max_priority: 0.95              # priority at boundary (high urgency)
    '''
    ...
    def _update_intent_vector(self, x, y, theta):
        ...
        # ┈┈┈┈┈┈┈┈┈┈┈┈┈┈┈┈┈┈┈┈┈┈┈┈┈┈┈┈┈┈┈┈┈┈┈┈┈┈┈┈┈┈┈┈┈┈┈┈┈┈┈┈┈┈┈┈┈┈┈┈┈┈┈┈┈┈
        # Y boundaries (forward/aft in WORLD frame = north/south)
        # ┈┈┈┈┈┈┈┈┈┈┈┈┈┈┈┈┈┈┈┈┈┈┈┈┈┈┈┈┈┈┈┈┈┈┈┈┈┈┈┈┈┈┈┈┈┈┈┈┈┈┈┈┈┈┈┈┈┈┈┈┈┈┈┈┈┈
